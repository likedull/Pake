...
const variables = {
  ...
  windows: {
    ...
    hdIconPath: `src-tauri/png/${process.env.NAME}_32.ico`,
    hdDefaultPath: 'src-tauri/png/icon_32.ico',
    icon: [`png/${process.env.NAME}_32.ico`, `png/${process.env.NAME}_32.ico`],
